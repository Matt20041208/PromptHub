package com.prompt.prompt.config;
...
public class RabbitMQConfig {
    ...
    @Bean
    public Queue promptRatingQueue() {
        return new Queue("prompt.rating.queue", true);
    }
    ...
    @Bean
    public Binding promptRatingBinding() {
        return BindingBuilder.bind(promptRatingQueue()).to(promptExchange()).with("prompt.rating");
    }
}
